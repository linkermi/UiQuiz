...
class DB{
   ...
   // Public $dataTypeMapping=Array(); 
     ...
     * @return boolean
     * @example <code>$result=Artikel::delete(27)</code><br><code>$result=Artikel::delete("DELETE FROM Artikel WHERE m_oid=? OR m_oid=?",[5,8])</code>
     */
    public static function delete($id,$param=array()){
      ...
      * @param Array $param Ordinales Array mit den Werten für die SQL Anweisung
      * @return boolean
       * @example <code>$result=db::execQuery("Update Artikel SET...WHERE m_oid=?,[...,27])</code>
       * 
      */
