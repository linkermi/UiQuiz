...
INSERT  IGNORE INTO `Antwort` (`m_oid`, `c_ts`, `m_ts`, `Antworttext`, `korrekt`, `to_Frage`, `ts`) VALUES (1,NULL,NULL,'Dittmann',1,1,'2019-01-09 12:34:38');
...
INSERT  IGNORE INTO `KategorieT` (`myval`, `codes`, `valActive`, `rno`, `ts`) VALUES ('IT',0,1,0,'2019-01-09 10:00:44'),('Controlling',1,1,1,'2019-01-09 10:00:44'),('Professoren',2,1,2,'2019-01-09 10:00:44'),('Pforzheim',3,1,3,'2019-01-09 10:00:44'),('Kneipen',4,1,4,'2019-01-09 10:00:44'),('Mathematik',5,1,5,'2019-01-09 10:00:44'),('SPO',6,1,6,'2019-01-09 10:00:44');
...
INSERT  IGNORE INTO `ResultT` (`myval`, `codes`, `valActive`, `rno`, `ts`) VALUES ('offen',0,1,0,'2019-01-09 10:00:44'),('falsch',1,1,1,'2019-01-09 10:00:44'),('richtig',2,1,2,'2019-01-09 10:00:44');
...
INSERT  IGNORE INTO `StatusT` (`myval`, `codes`, `valActive`, `rno`, `ts`) VALUES ('erstellt',0,1,0,'2019-01-09 10:00:45'),('gestartet',1,1,1,'2019-01-09 10:00:45'),('beendet',2,1,2,'2019-01-09 10:00:45');
...
INSERT  IGNORE INTO `User` (`m_oid`, `c_ts`, `m_ts`, `nachname`, `vorname`, `kennung`, `passwort`, `gruppe`, `rating`, `nickname`, `bild`, `ts`) VALUES (1,1,1359615962,'Nippa','Markus','nippa','098f6bcd4621d373cade4e832627b4f6',1,NULL,NULL,NULL,'2018-12-13 14:55:49'),(2,2,1359615962,'Schätter','Alfred','schaetter','098f6bcd4621d373cade4e832627b4f6',2,NULL,NULL,NULL,'2018-12-13 14:55:49');
...
-- Dump completed on 2019-01-09 14:42:57
